...
from .views import crear_categoria,reporte_gestion,cerrar_gestion,reporte_materiales_entrada,anadir_nuevo_cantidad,eliminar_categoria,actualizar_categoria,listar_categoria_id ,crear_material, listado_material,informacion_material, softDelete, editar_material, inprimir
urlpatterns = [
