    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.CharField(choices=[('Presupuestos', 'Presupuestos'), ('Cardista', 'Cardista'), ('Director_administrativo', 'Director Administrativo'), ('Encargado_oficina', 'Responsable de la oficina'), ('Usuario', 'Personal de la oficina')], default='Usuario', verbose_name='Encargado de unidad')),
                ...
                ('foto', models.ImageField(blank=True, null=True, upload_to='upload/', verbose_name='Imagen de perfil')),
